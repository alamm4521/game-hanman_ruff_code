...
def set_seed(a):
    ...
    :return: None
    """
    a = random.randrange(1,a)

    return a


def load_words(file='ex4_tests\words.txt'):
    """
...
def get_input():
    ...
    """
    #Asks the player for his input. He can guess a letter, a word of asks for a hint.
    #choice = input("input word, letter , or ? for hint")
...
def show_suggestions(matches):
    ...
    :return: None
    """
    #https://www.educative.io/answers/how-to-use-getclosematches-in-python

    #word to lettter show
